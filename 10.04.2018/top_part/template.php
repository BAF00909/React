...
foreach($arResult as $arItem):?>
	...
	<?if ($arItem["IS_PARENT"]):?>
		...
		<?else:?>
			<li<?if ($arItem["SELECTED"]):?> class="dropdown item-selected active"<?endif?>><a class="dropdown-toggle marker" data-toggle="dropdown" href="<?=$arItem["LINK"]?>" class="parent"><?=$arItem["TEXT"]?><b class="caret"></b></a>
				<ul class="dropdown-menu">
		<?endif?>
