...
<main id="main">	
<div id="nvxRequestForm">
	<h1 class="service-h1" data-bind="text: pageTitle"></h1>
	<!-- ko if: backText -->
	<a class="btn primary button b-back button-small" data-bind="attr: {href: backUrl }, text: backText" rel="back"></a>
	<!-- /ko -->
	<div class="paddings" data-bind="css: { 'hasBack': backText }">
		...
		<div>
			...
			<div class="btn button b-solid button-small" data-bind="click: editButtonClick">Редактировать</div>
			<!-- /ko -->
		...
		<!-- ko if: useNextButton -->
		<div class="btn primary b-solid b-modal button-small button-small--blue" data-bind="click: nextAction, text: nextText"></div>
		<!-- /ko -->
	</div>
</div>
</main>
