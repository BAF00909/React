...
<div class="modal fade" id="support-mfc" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<script src="<?=SITE_TEMPLATE_PATH?>/../mfc31/Portal/script/requirejs/require.min.js"> </script>
		<script src="<?=SITE_TEMPLATE_PATH?>/../mfc31/Portal/script/requirejs-config.js"> </script>
		<script src="<?=SITE_TEMPLATE_PATH?>/../mfc31/Parts/Script/parts.bundle.rdc_v38.js"> </script>
