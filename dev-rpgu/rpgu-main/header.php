...
<head>
	...
	<title>Региональный портал государственных и муниципальных услуг Белгородской области</title>
...
<?$APPLICATION->ShowPanel();?> 
			...
			<header id="header">
				<div class="container">
					...
					<div class="logo-holder">
						<!-- logo -->
						<h1 class="logo pull-left"><a href="/"><img src="<?=SITE_TEMPLATE_PATH?>/images/logo_svg.svg" alt="Госуслуги"></a></h1>
	...
	false
		...
		<div class="slider-area">
			<div id="nvxAccount" class="container">
			<!-- ko if: userLoggedStatus() == false -->
			<div class="accaunt-slide">
				<div class="accaunt-slide__block">
					<div class="accaunt-slide__logo">
						<img src="<?=SITE_TEMPLATE_PATH?>/../rpgu-main/Parts/Img/gos_logo.svg" alt="logo-gosuslug">
					</div>
					<div class="accaunt-slide__slogan">
						<h4 class="service-h4">Теперь пользоваться госуслугами очень просто!</h4>
					</div>
					<div class="accaunt-slide__buttons">
						<a href="#" class="buttons-sing-up-accaunt button-small button-small--blue" data-bind="click: click">Войти</a>
						<a href="https://esia.gosuslugi.ru/registration/" class="buttons-registr-accaunt button-small">Зарегистрироваться</a>
					</div>
				</div>
			</div>
			<!-- /ko -->
			...
			<div class="slideshow">
				<div class="slideset">
					<!-- slide -->
					<div class="slide">
						<div class="img-holder" style="background-image: url(<?=SITE_TEMPLATE_PATH?>/images/registration.jpg);background-size: contain;"></div>
						<div class="container">
							<div class="col-6">
					...
					<!-- slide -->
					<div class="slide">
						<div class="img-holder" style="background-image: url(<?=SITE_TEMPLATE_PATH?>/images/registration-childgarden2.jpg);background-size: contain;"></div>
						<div class="container">
							<div class="col-6">
					...
					<!-- slide -->
					<div class="slide">
						<div class="img-holder" style="background-image: url(<?=SITE_TEMPLATE_PATH?>/images/registration-doctor.jpg);background-size: contain;"></div>
						<div class="container">
							<div class="col-6">
