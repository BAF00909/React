;(function () {
  ...
  //       return false;
    ...
    {
		if(document.getElementById('nvxRequestForm')){	
        ...
        {  
            ...
            ovr.innerHTML = "<div id='cadesplugin_ovr_item' style='position:relative; width:400px; margin:100px auto; background-color:#fff; border:2px solid #000; padding:10px; text-align:center; opacity: 1; z-index: 1500'>" +
                            ...
                            "<p><a href='https://www.cryptopro.ru/sites/default/files/products/cades/extensions/firefox_cryptopro_extension_latest.xpi'>Установить расширение</a></p>" +
                            "</div>";
